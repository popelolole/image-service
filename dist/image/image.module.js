...
exports.ImageModule = ImageModule = __decorate([
    (0, common_1.Module)({
        imports: [mongoose_1.MongooseModule.forFeature([{ name: image_db_1.Image.name, schema: image_db_1.ImageSchema }])],
        controllers: [image_controller_1.ImageController],
        providers: [image_service_1.ImageService, persistence_1.Persistence]
    })
], ImageModule);
